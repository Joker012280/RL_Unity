...
public class Planner_dh3 : MonoBehaviour
{
    // ROS Connector
    public ROSConnection ros;
    private int numRobotJoints = 6;
    //[Header("Don't touch")]
    public bool _waituntilTrue = true;
    ...
    [Header("Don't touch")]
    public MoverServiceResponse trajec = new MoverServiceResponse();
    private enum Poses
    {
        PreGrasp,
        Grasp,
    ...
    public void PublishJoints()
    {
        ...
        //randX = (float)Random.Range(-0.3f,0.3f);
        //randZ = (float)Random.Range(0.1f,0.12f);
        //target.transform.position = new UnityEngine.Vector3(randX,0.64f,randZ);
    ...
    void TrajectoryResponse(MoverServiceResponse response)
    {
        if (response.trajectories != null)
        {
            ...
            StartCoroutine(rosaction(response));
    ...
    /// <returns></returns>
    public IEnumerator ExecuteTrajectories(MoverServiceResponse response)
    {
        if (response.trajectories != null)
        {
    ...
    public IEnumerator rosaction(MoverServiceResponse response)
    {
        Debug.Log("I'm inside in rosaction");
        yield return StartCoroutine(ExecuteTrajectories(response));
        _waituntilTrue = false;
    }
